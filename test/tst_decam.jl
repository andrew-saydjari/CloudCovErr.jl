module tst_cov
    ...
    @testset "DECam" begin
        ...
        @test_nowarn cloudCovErr.proc_all(test_dir*"/data/decaps/c4d_","170119_085651","r","v1",test_dir*"/data/",resume=true,corrects7=true,thr=20,outthr=20000,Np=33,widx=129,tilex=8)
    end
end
